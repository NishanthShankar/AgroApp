...
class HomeItem extends Component {
  ...
  static getDerivedStateFromProps (props, state) {
    console.log('PS:', props.selected, state.selected, props.selected !== state.selected)
  ...
  constructor (props) {
    ...
    if (this.props.selected) this.animate(this.props.selected)
  }

  componentDidUpdate (prevProps, prevState) {
    console.log('PSCDU:', this.state.selected, prevState.selected)
